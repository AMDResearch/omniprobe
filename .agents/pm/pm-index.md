...
| `omniprobe-cli` | Python orchestrator script — CLI options, analyzer config, HIP/Triton workflow, Python API (`omniprobe/api/`) | active | code | Working on omniprobe/omniprobe, config/, or omniprobe/api/ | interceptor, handler-pipeline |
