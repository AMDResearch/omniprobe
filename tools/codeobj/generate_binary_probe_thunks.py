...
def render_dh_builtin_capture_lines(when: str) -> list[str]:
    return [
        ...
        "  const auto *__omniprobe_entry_snapshot = runtime.entry_snapshot;",
        "  const auto *__omniprobe_dispatch_uniform = runtime.dispatch_uniform;",
        "  const bool __omniprobe_has_entry_snapshot = __omniprobe_entry_snapshot != nullptr &&",
        "      (__omniprobe_entry_snapshot->wavefront_size != 0);",
        ...
        "  __omniprobe_dh_builtins.block_idx_x = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->workgroup_x",
        "      : 0u;",
        "  __omniprobe_dh_builtins.block_idx_y = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->workgroup_y",
        "      : 0u;",
        "  __omniprobe_dh_builtins.block_idx_z = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->workgroup_z",
        "      : 0u;",
        "  const uint32_t __omniprobe_builtin_thread_idx_x = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->thread_x",
        "      : 0u;",
        "  const uint32_t __omniprobe_builtin_thread_idx_y = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->thread_y",
        "      : 0u;",
        "  const uint32_t __omniprobe_builtin_thread_idx_z = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->thread_z",
        "      : 0u;",
        ...
        "  __omniprobe_dh_builtins.lane_id = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->lane_id",
        "      : 0u;",
        "  __omniprobe_dh_builtins.wavefront_size = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->wavefront_size",
        "      : 0u;",
        "  __omniprobe_dh_builtins.wave_num = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->wave_id",
        "      : 0u;",
        "  __omniprobe_dh_builtins.exec = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->exec_mask",
        "      : 0u;",
        "  __omniprobe_dh_builtins.xcc_id = 0;",
        "  const uint32_t __omniprobe_builtin_hw_id = __omniprobe_has_entry_snapshot",
        "      ? __omniprobe_entry_snapshot->hw_id",
        "      : 0u;",
